...
public class ServerManagerMenuCommand extends SubCommand {
    public ServerManagerMenuCommand(String mainCommandName) {
    ...
    public boolean onPlayerCommand(Player player, String[] args) {
        ...
        new ServerManagerMenu(AdminPanelMain.getAPI().getPlayerMenuUtility(target)).open();
    ...
    @Override
    public String info() {
        return "Opens the ServerManagerMenu";
    }
    ...
    public String syntax() {
        return "/openpanel ServerManagerMenu";
    }

    @Override
    public String permission() {
        return new ServerManagerMenu(null).getOpeningPermission();
    }
}
