...
public class PluginAutoUpdaterMenuCommand extends SubCommand {
    public PluginAutoUpdaterMenuCommand(String mainCommandName) {
    ...
    public boolean onPlayerCommand(Player player, String[] args) {
        if (args.length == 0) {
            new PluginAutoUpdaterMenu(AdminPanelMain.getAPI().getPlayerMenuUtility(player)).open();
        ...
        new PluginAutoUpdaterMenu(AdminPanelMain.getAPI().getPlayerMenuUtility(target)).open();
    ...
    @Override
    public String info() {
        return "Opens the PluginAutoUpdaterMenu";
    }
    ...
    public String syntax() {
        return "/openpanel PluginAutoUpdaterMenu";
    }
