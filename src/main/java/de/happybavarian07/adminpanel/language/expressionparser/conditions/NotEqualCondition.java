 ...
 */
public class NotEqualCondition extends AbstractMaterialCondition {
    private final Object value1;
    private final Object value2;

    /**
     * Creates a new not equal condition.
     *
     * @param value1 the first value
     * @param value2 the second value
     */
    public NotEqualCondition(Object value1, Object value2) {
        super("NotEqual");
        this.value1 = value1;
        this.value2 = value2;
    }
    ...
    /**
     * Creates a new not equal condition with materials.
     *
     * @param value1 the first value
     * @param value2 the second value
     ...
     */
    public NotEqualCondition(Object value1, Object value2, Material trueMaterial, Material falseMaterial, Material defaultMaterial) {
        super("NotEqual", trueMaterial, falseMaterial, defaultMaterial);
        this.value1 = value1;
        this.value2 = value2;
    }
