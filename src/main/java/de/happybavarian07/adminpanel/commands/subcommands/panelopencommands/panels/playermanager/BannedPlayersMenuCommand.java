package de.happybavarian07.adminpanel.commands.subcommands.panelopencommands.panels.playermanager;/*
 * @Author HappyBavarian07
 * @Date 27.04.2022 | 17:25
 */
...
import de.happybavarian07.adminpanel.menusystem.menu.playermanager.BannedPlayersMenu;
...
public class BannedPlayersMenuCommand extends SubCommand {
    public BannedPlayersMenuCommand(String mainCommandName) {
    ...
    @Override
    public String info() {
        return "Opens the BannedPlayersMenu";
    }
    ...
    public String syntax() {
        return "/openpanel BannedPlayersMenu";
    }
