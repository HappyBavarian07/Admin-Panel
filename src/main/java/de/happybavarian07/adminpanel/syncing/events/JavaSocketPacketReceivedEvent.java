...
public class JavaSocketPacketReceivedEvent extends AdminPanelEvent implements Cancellable {
    private static final HandlerList handlers = new HandlerList();
    private final Packet dataPacket;
    private boolean cancelled;

    public JavaSocketPacketReceivedEvent(Packet dataPacket) {
    ...
    /**
     * Gets the Data Client Instance of the Plugin
     * {@link DataClient}
