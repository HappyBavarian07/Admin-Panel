package de.happybavarian07.adminpanel.commands.subcommands.panelopencommands.panels.worldmanager;/*
...
public class WorldSelectMenuCommand extends SubCommand {
    public WorldSelectMenuCommand(String mainCommandName) {
    ...
    public boolean onPlayerCommand(Player player, String[] args) {
        ...
        new WorldSelectMenu(AdminPanelMain.getAPI().getPlayerMenuUtility(target)).open();
    ...
    @Override
    public String info() {
        return "Opens the WorldSelectMenu";
    }
    ...
    public String syntax() {
        return "/openpanel WorldSelectMenu";
    }

    @Override
    public String permission() {
        return new WorldSelectMenu(null).getOpeningPermission();
    }
}
