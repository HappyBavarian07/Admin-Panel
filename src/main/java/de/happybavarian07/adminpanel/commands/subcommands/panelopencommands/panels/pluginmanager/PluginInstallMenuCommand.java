package de.happybavarian07.adminpanel.commands.subcommands.panelopencommands.panels.pluginmanager;/*
 * @Author HappyBavarian07
 * @Date 27.04.2022 | 17:28
 */
...
import de.happybavarian07.adminpanel.menusystem.menu.pluginmanager.PluginInstallMenu;
...
public class PluginInstallMenuCommand extends SubCommand {
    public PluginInstallMenuCommand(String mainCommandName) {
    ...
    public boolean onPlayerCommand(Player player, String[] args) {
        if (args.length == 0) {
            new PluginInstallMenu(AdminPanelMain.getAPI().getPlayerMenuUtility(player)).open();
        ...
        new PluginInstallMenu(AdminPanelMain.getAPI().getPlayerMenuUtility(target)).open();
    ...
    @Override
    public String info() {
        return "Opens the PluginInstallMenu";
    }
    ...
    public String syntax() {
        return "/openpanel PluginInstallMenu";
    }

    @Override
    public String permission() {
        return new PluginInstallMenu(null).getOpeningPermission();
    }
}
