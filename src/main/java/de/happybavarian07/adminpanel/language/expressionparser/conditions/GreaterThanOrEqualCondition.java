 ...
 */
public class GreaterThanOrEqualCondition extends AbstractMaterialCondition {
     ...
     */
    public GreaterThanOrEqualCondition(Object value1, Object value2) {
    ...
    /**
     * Creates a new greater than or equal condition with materials.
     *
     * @param value1 the first value
     * @param value2 the second value
     ...
     */
    public GreaterThanOrEqualCondition(Object value1, Object value2, Material trueMaterial, Material falseMaterial, Material defaultMaterial) {
        super("GreaterThanOrEqual", trueMaterial, falseMaterial, defaultMaterial);
        this.value1 = value1;
        this.value2 = value2;
    }
