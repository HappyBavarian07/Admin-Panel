...
public class Resource {
    ...
    private io.CodedByYou.spiget.Rating rating;
    ...
    public Resource(String resourcename) throws Exception {
        ...
        rating = new io.CodedByYou.spiget.Rating(object.getInt("count"),object.getInt("average"));
    ...
    public io.CodedByYou.spiget.Rating getRating() {
        return rating;
    }
