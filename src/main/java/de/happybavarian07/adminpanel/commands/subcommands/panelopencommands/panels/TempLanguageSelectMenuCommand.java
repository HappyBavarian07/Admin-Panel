package de.happybavarian07.adminpanel.commands.subcommands.panelopencommands.panels;/*
...
import de.happybavarian07.adminpanel.menusystem.menu.TempLanguageSelectMenu;
...
public class TempLanguageSelectMenuCommand extends SubCommand {
    public TempLanguageSelectMenuCommand(String mainCommandName) {
    ...
    @Override
    public String info() {
        return "Opens the TempLanguageSelectMenu";
    }
    ...
    public String syntax() {
        return "/openpanel TempLanguageSelectMenu";
    }
