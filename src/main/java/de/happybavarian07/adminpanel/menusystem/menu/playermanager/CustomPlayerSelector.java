...
public class CustomPlayerSelector extends PaginatedMenu {
    // TODO Menu mit einem PlayerSelector der eine Methode ausführt wenn ein Spieler angeklickt wird (die kann man im Constructor angeben)
    private final Menu methodMenu;

    public CustomPlayerSelector(PlayerMenuUtility playerMenuUtility, Menu methodMenu) {
